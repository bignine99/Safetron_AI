// hero-particles.js - Generative Mountain Scene
...
const vertexShader = `
  ...
  void main() {
      ...
      // Recalculate normal roughly based on displacement
      // (For a true normal we should use derivatives, but since we are transforming the vertex we'll use a hack or just pass the transformed normal)
...
const fragmentShader = `
  ...
  void main() {
      ...
      // Apply some base opacity so it's not totally invisible in the shadows
      float alpha = max(0.1, diffuse + fresnel * 0.5) * 0.7;
...
const material = new THREE.ShaderMaterial({
  ...
  uniforms: {
    ...
    color: { value: new THREE.Color("#38bdf8") }, // Safetron blue accent color
  },
  vertexShader,
  fragmentShader,
  transparent: true,
