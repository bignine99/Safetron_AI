...
const QUICK_ITEMS = [
  { id: 'CO_(주)한진건축', label: '(주)한진건축', sub: '99건 이상의 복합 사고 연관망' },
  { id: 'CO_주식회사 라인씨앤씨', label: '라인씨앤씨', sub: '96건 이상의 복합 사고 연관망' },
  { id: 'CO_주식회사 청솔종합건설', label: '청솔종합건설', sub: '95건 이상의 복합 사고 연관망' },
  { id: 'CO_(주)경남건설개발', label: '(주)경남건설개발', sub: '91건 이상의 복합 사고 연관망' },
  { id: 'CO_주식회사 동건건설기술', label: '동건건설기술', sub: '다수 사고 발생 시공사' },
  { id: '2019-00050', label: '사고: 동바리 붕괴', sub: '대표 중대재해 연관망' },
  { id: '2019-00087', label: '사고: 크레인 파단', sub: '대표 위험설비 사고망' },
  { id: '2019-00162', label: '사고: 추락(개구부)', sub: '다빈도 추락재해 분석망' },
  { id: '2019-00006', label: '사고: 감전(가설전기)', sub: '다빈도 감전재해 분석망' },
  { id: '2019-00066', label: '사고: 질식(밀폐공간)', sub: '고위험 밀폐공간 분석망' }
];
...
const GUIDE_ACTIONS = [
  {
    ...
    color: '#ef4444',
    title: '사고 패턴 분석 (TBM)',
    subtitle: '동바리 붕괴 심층 시각화',
    desc: '특정 사고 건(예: 2019-00050)을 2-hop으로 탐색하여 연관된 시공사 및 파생 관계를 분석합니다.',
    action: { nodeId: '2019-00050', depth: 2, max: 50 },
  },
  {
    num: 2,
    icon: Building2,
    color: '#2563eb',
    title: '시공사 프로파일링',
    subtitle: '입찰/협력사 리스크 평가',
    desc: '특정 시공사(한진건축)를 중심으로 과거 사고 이력과 사고 유형 분포를 조회합니다. 협력업체의 안전 이력을 객관적으로 분석하여 사전 대조군을 형성합니다.',
    action: { nodeId: 'CO_(주)한진건축', depth: 2, max: 80 },
  },
  {
    num: 3,
    icon: MapPin,
    ...
    title: '고위험 시공망 탐색',
    subtitle: '안전관리계획서 점검',
    desc: '라인씨앤씨와 96번 이상 연결된 다수의 사고 패턴을 분석합니다. 다중 사고 발생의 구조적 맥락을 빅데이터로 검증합니다.',
    action: { nodeId: 'CO_주식회사 라인씨앤씨', depth: 2, max: 80 },
  },
  {
    num: 4,
    icon: GraduationCap,
    color: '#8b5cf6',
    title: '안전 교육 콘텐츠망',
    subtitle: '교육 자료 제작 최적화',
    desc: '사고 사례 복합건(2019-00162)을 중심으로 관련 시공사, 장소, 기인물을 시각화하여 위험 현장 교육 자료 기획에 투입합니다.',
    action: { nodeId: '2019-00162', depth: 2, max: 50 },
  },
];
