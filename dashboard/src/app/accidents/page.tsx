...
const GUIDE_ACTIONS = [
  {
    ...
    title: '사고 패턴 분석',
    subtitle: 'TBM 미팅 활용',
    desc: '특정 사고 건(예: 2019-00001)을 2-hop으로 탐색하여 연관된 시공사 및 파생 관계를 분석합니다. (현재 타입 분석 AI 노드는 추출 중입니다)',
    action: { nodeId: '2019-00001', depth: 2, max: 30 },
  },
  {
    num: 2,
    icon: Building2,
    ...
    title: '시공사 프로파일링',
    subtitle: '입찰 평가 활용',
    desc: '특정 시공사(포스코건설산업)를 중심으로 과거 사고 이력과 사고 유형 분포를 조회합니다. 협력업체의 안전 이력을 객관적으로 분석하여 리스크를 사전에 파악합니다.',
    action: { nodeId: 'CO_주식회사 포스코건설산업', depth: 2, max: 20 },
  },
  {
    num: 3,
    icon: MapPin,
    ...
    title: '사고 원인 교차 분석',
    subtitle: '안전관리계획서 활용',
    desc: '동건건설기술에서 발생한 사고의 공통 패턴을 분석합니다. 사고와 연결된 시공사, 다중 사고 발생 관계자를 한눈에 파악합니다.',
    action: { nodeId: 'CO_주식회사 동건건설기술', depth: 2, max: 25 },
  },
  {
    num: 4,
    icon: GraduationCap,
    ...
    title: '안전 교육 콘텐츠',
    subtitle: '교육 자료 제작',
    desc: '사고 사례 2019-00002건을 중심으로 관련 시공사, 장소, 기인물을 시각화합니다. (위치 데이터 실시간 스캔 중)',
    action: { nodeId: '2019-00002', depth: 2, max: 10 },
  },
];
